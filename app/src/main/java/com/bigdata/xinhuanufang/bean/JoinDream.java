...
public class JoinDream {
    /**
     *  "think_id":"1",
     "think_percent":"9",
     "thinkjoin_gloves":"333",
     "user_id":"1",
     "thinkjoin_bili":"10.00000"
     */
    ...
    public JoinDream(String think_id, String think_percent, String thinkjoin_gloves, String user_id, String thinkjoin_bili) {
        this.think_id = think_id;
        this.think_percent = think_percent;
        this.thinkjoin_gloves = thinkjoin_gloves;
        this.user_id = user_id;
