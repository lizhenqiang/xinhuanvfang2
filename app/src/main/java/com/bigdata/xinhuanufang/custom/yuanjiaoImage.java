...
public class yuanjiaoImage extends ImageView{
    //数据定义  new PorterDuffXfermode(Mode.DST_IN);
    ...
    //构造方法
    public yuanjiaoImage(Context context){
        this(context, null);
    }
    public yuanjiaoImage(Context context, AttributeSet attrs) {
        super(context, attrs);
