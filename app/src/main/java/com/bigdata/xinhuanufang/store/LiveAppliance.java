 ...
 * 生活用品
 */
public class LiveAppliance extends BaseActivity implements OnItemClickListener,
    ...
    protected void showListView(List<LiveUseing_shoping_List> finghter2) {
        ...
        // 在底部加载一个j
        topNewsMoreAdapter = new LiveUseingAdapter(LiveAppliance.this, finghter2);
    ...
    protected void initNewDatas(int page) {
        ...
        x.http().get(
                new RequestParams(Config.ip + Config.app
                        + "/shop_list.php?type=" + Config.LiveUseing + "&page="
