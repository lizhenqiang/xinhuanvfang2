package com.bigdata.xinhuanufang.store.picture;
...
import com.bigdata.xinhuanufang.mine.SuggestionBackActivity;
import com.bigdata.xinhuanufang.store.picture.ImgsAdapter.OnItemClickClass;
...
//		imgGridView.setOnItemClickListener(this);
	...
	public ImageView iconImage(String filepath,int index,CheckBox checkBox) throws FileNotFoundException{
		...
		imageView.setBackgroundResource(R.drawable.sctp);
		float alpha=100;
	...
	public void sendfiles(View view){
		Intent intent =new Intent(this, SuggestionBackActivity.class);
