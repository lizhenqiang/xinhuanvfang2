...
public class StoreElectron extends BaseActivity implements OnItemClickListener,
    ...
    protected void showListView(List<LiveUseing_shoping_List> finghter2) {
        // 查找到list控件
        topNewsMoreLV = (LoadListViewnews) findViewById(R.id.lv_more_topnew);
        topNewsMoreLV.setInterface(this);
        // 在底部加载一个j
        topNewsMoreAdapter = new LiveUseingAdapter(StoreElectron.this, shop_list_child);
    ...
    protected void initNewDatas(int page) {
        ...
        x.http().get(
                new RequestParams(Config.ip + Config.app
                        + "/shop_list.php?type=" + Config.Electron + "&page="
