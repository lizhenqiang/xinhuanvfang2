...
public class mineMySuperDreamDaishixianBean {
/**
 *    "think_id":"2",
            "think_shopid":"1",
            "think_attrid":"15",
 ...
 */
	...
	private List<mineMySuperDreamDaishixianBeanPic> pic;
	...
	public List<mineMySuperDreamDaishixianBeanPic> getPic() {
		return pic;
	}
	public void setPic(List<mineMySuperDreamDaishixianBeanPic> pic) {
		this.pic = pic;
	}
	...
	public mineMySuperDreamDaishixianBean(String think_id, String think_shopid,
			String think_attrid, String think_percent, String think_title,
			String think_pic, String think_price,
			List<mineMySuperDreamDaishixianBeanPic> pic, String is_add) {
		this.think_id = think_id;
		this.think_shopid = think_shopid;
		this.think_attrid = think_attrid;
		this.think_percent = think_percent;
